...
It is now possible to define custom aliases for top-level commands. The [documentation of configuration](doc/02_configuration.md)) provides now a section, describing the details.
