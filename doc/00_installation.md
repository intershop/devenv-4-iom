...
Docker Desktop can be used as an alternative. Only the **kubeadm** engine is supported — the **kind** engine (the new default since Docker Desktop 4.40) cannot be used with _devenv-4-iom_. See [Docker Desktop — kind Engine](09_docker_desktop_kind.md) for details.
